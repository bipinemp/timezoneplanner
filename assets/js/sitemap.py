...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
    ...
    <!-- Main Pages -->
    <url>
        <loc>https://globalmeetingplanner.xyz/</loc>
        <lastmod>{}</lastmod>
    ...
    <url>
        <loc>https://globalmeetingplanner.xyz/about.html</loc>
        <lastmod>{}</lastmod>
    ...
    <url>
        <loc>https://globalmeetingplanner.xyz/how-it-works.html</loc>
        <lastmod>{}</lastmod>
        <changefreq>monthly</changefreq>
    ...
    <url>
        <loc>https://globalmeetingplanner.xyz/time-zone-guide.html</loc>
        <lastmod>{}</lastmod>
        <changefreq>monthly</changefreq>
        <priority>0.7</priority>
    </url>
    ...
    <url>
        <loc>https://globalmeetingplanner.xyz/meeting-tips.html</loc>
        <lastmod>{}</lastmod>
        <changefreq>monthly</changefreq>
    ...
    <url>
        <loc>https://globalmeetingplanner.xyz/contact.html</loc>
        <lastmod>{}</lastmod>
        <changefreq>monthly</changefreq>
    ...
    <url>
        <loc>https://globalmeetingplanner.xyz/privacy-policy.html</loc>
        <lastmod>{}</lastmod>
    ...
    <url>
        <loc>https://globalmeetingplanner.xyz/terms-of-service.html</loc>
        <lastmod>{}</lastmod>
        <changefreq>yearly</changefreq>
        <priority>0.3</priority>
    </url>
    ...
    for tz1, tz2 in popular_pairs:
        ...
        sitemap_content += f'''
    <url>
        <loc>https://globalmeetingplanner.xyz/{slug}.html</loc>
...
def main():
    ...
    for i, (tz1, tz2) in enumerate(popular_pairs[:10]):
        slug = slugify(tz1, tz2)
        print(f"  • https://globalmeetingplanner.xyz/{slug}.html")
